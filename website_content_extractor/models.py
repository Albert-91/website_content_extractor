...
class QueueTask(Timestamps, models.Model):
    ...
    get_text = models.BooleanField(verbose_name=_("get texts"), default=True, blank=True)
    get_image = models.BooleanField(verbose_name=_("get images"), default=True, blank=True)
